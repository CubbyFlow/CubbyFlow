...
#ifndef CUBBYFLOW_CUDA_SPH_SYSTEM_DATA2_HPP
#define CUBBYFLOW_CUDA_SPH_SYSTEM_DATA2_HPP
...
class CUDASPHSystemData2 : public CUDAParticleSystemData2
{
 public:
    ...
    ~CUDASPHSystemData2() override = default;

    //! Copy constructor.
    CUDASPHSystemData2(const CUDASPHSystemData2& other);

    //! Move constructor.
    CUDASPHSystemData2(CUDASPHSystemData2&& other) noexcept;

    //! Copy assignment operator.
    CUDASPHSystemData2& operator=(const CUDASPHSystemData2& other);

    //! Move assignment operator.
    CUDASPHSystemData2& operator=(CUDASPHSystemData2&& other) noexcept;
...
using CUDASPHSystemData2Ptr = std::shared_ptr<CUDASPHSystemData2>;
