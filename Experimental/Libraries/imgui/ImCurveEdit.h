...
namespace ImCurveEdit
{
   ...
   struct Delegate
   {
      ...
      virtual bool IsVisible(size_t curveIndex) { (void)curveIndex; return true; }
      virtual CurveType GetCurveType(size_t curveIndex) const { (void)curveIndex; return CurveLinear; }
