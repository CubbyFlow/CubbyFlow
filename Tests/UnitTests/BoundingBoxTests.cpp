...
{
	{
		...
		EXPECT_DOUBLE_EQ(std::numeric_limits<double>::max(), box.lowerCorner[0]);
		EXPECT_DOUBLE_EQ(std::numeric_limits<double>::max(), box.lowerCorner[1]);

		EXPECT_DOUBLE_EQ(-std::numeric_limits<double>::max(), box.upperCorner[0]);
		EXPECT_DOUBLE_EQ(-std::numeric_limits<double>::max(), box.upperCorner[1]);
	}
