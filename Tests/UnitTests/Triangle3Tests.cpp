...
TEST(Triangle3, Constructors)
{
    ...
    std::array<Vector3D, 3> points = { { Vector3D(1, 2, 3), Vector3D(4, 5, 6),
                                         Vector3D(7, 8, 9) } };
    std::array<Vector3D, 3> normals = { { Vector3D(1, 0, 0), Vector3D(0, 1, 0),
                                          Vector3D(0, 0, 1) } };
    std::array<Vector2D, 3> uvs = { { Vector2D(1, 0), Vector2D(0, 1),
                                      Vector2D(0.5, 0.5) } };
...
{
    Triangle3 tri;
    tri.points = { { Vector3D(0, 0, -1), Vector3D(1, 0, -1),
                     Vector3D(0, 1, -1) } };
...
TEST(Triangle3, SurfaceGetters)
{
    ...
    tri.points = { { Vector3D(0, 0, -1), Vector3D(1, 0, -1),
                     Vector3D(0, 1, -1) } };
    tri.normals = { { Vector3D(1, 0, 0), Vector3D(0, 1, 0),
                      Vector3D(0, 0, 1) } };
    ...
    auto cints1 =
        tri.ClosestIntersection(Ray3D({ 0.4, 0.4, -5.0 }, { 0, 0, 1 }));
