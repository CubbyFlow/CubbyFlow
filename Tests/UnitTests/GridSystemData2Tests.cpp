...
TEST(GridSystemData2, Serialize)
{
	...
	size_t scalarIdx0 = grids.AddScalarData(std::make_shared<CellCenteredScalarGrid2::Builder>());
	size_t vectorIdx0 = grids.AddVectorData(std::make_shared<CellCenteredVectorGrid2::Builder>());
	size_t scalarIdx1 = grids.AddAdvectableScalarData(std::make_shared<VertexCenteredScalarGrid2::Builder>());
	size_t vectorIdx1 = grids.AddAdvectableVectorData(std::make_shared<VertexCenteredVectorGrid2::Builder>());
	...
	EXPECT_TRUE(std::dynamic_pointer_cast<CellCenteredScalarGrid2>(scalar0_2) != nullptr);
	...
	auto cell_vector0 = std::dynamic_pointer_cast<CellCenteredVectorGrid2>(vector0);
	auto cell_vector0_2 = std::dynamic_pointer_cast<CellCenteredVectorGrid2>(vector0_2);
	...
	EXPECT_TRUE(std::dynamic_pointer_cast<VertexCenteredScalarGrid2>(scalar1_2) != nullptr);
	...
	auto vert_vector1 = std::dynamic_pointer_cast<VertexCenteredVectorGrid2>(vector1);
	auto vert_vector1_2 = std::dynamic_pointer_cast<VertexCenteredVectorGrid2>(vector1_2);
