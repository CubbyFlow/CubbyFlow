...
TEST(GridSystemData3, Constructors)
{
	...
	GridSystemData3 grids2({ 32, 64, 48 }, { 1.0, 2.0, 3.0 }, { -5.0, 4.5, 10.0 });
...
TEST(GridSystemData3, Serialize)
{
	...
	GridSystemData3 grids({ 32, 64, 48 }, { 1.0, 2.0, 3.0 }, { -5.0, 4.5, 10.0 });

	size_t scalarIdx0 = grids.AddScalarData(std::make_shared<CellCenteredScalarGrid3::Builder>());
	size_t vectorIdx0 = grids.AddVectorData(std::make_shared<CellCenteredVectorGrid3::Builder>());
	size_t scalarIdx1 = grids.AddAdvectableScalarData(std::make_shared<VertexCenteredScalarGrid3::Builder>());
	size_t vectorIdx1 = grids.AddAdvectableVectorData(std::make_shared<VertexCenteredVectorGrid3::Builder>());
