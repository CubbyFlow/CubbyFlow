/*************************************************************************
> File Name: GridForwardEulerDiffusionSolver.cpp
...
{
	pybind11::class_<GridForwardEulerDiffusionSolver2, GridForwardEulerDiffusionSolver2Ptr, GridDiffusionSolver2>(static_cast<pybind11::handle>(m), "GridForwardEulerDiffusionSolver2",
		R"pbdoc(
	...
	.def(pybind11::init<>())
	.def("Solver", [](GridForwardEulerDiffusionSolver2& instance, Grid2Ptr source,
...
{
	pybind11::class_<GridForwardEulerDiffusionSolver3, GridForwardEulerDiffusionSolver3Ptr, GridDiffusionSolver3>(static_cast<pybind11::handle>(m), "GridForwardEulerDiffusionSolver3",
		R"pbdoc(
	...
	.def(pybind11::init<>())
	.def("Solver", [](GridForwardEulerDiffusionSolver3& instance, Grid3Ptr source,
