...
GridSystemData2::GridSystemData2(const Vector2UZ& resolution,
...
GridSystemData2::GridSystemData2(const GridSystemData2& other)
{
    ...
    m_velocity = std::dynamic_pointer_cast<FaceCenteredGrid2>(
...
GridSystemData2& GridSystemData2::operator=(const GridSystemData2& other)
{
    Resize(other.m_resolution, other.m_gridSpacing, other.m_origin);
...
void GridSystemData2::Resize(const Vector2UZ& resolution,
                             const Vector2D& gridSpacing,
                             const Vector2D& origin)
{
...
Vector2UZ GridSystemData2::GetResolution() const
{
    return m_resolution;
}
...
const ScalarGrid2Ptr& GridSystemData2::GetAdvectableScalarDataAt(
    size_t idx) const
{
    return m_advectableScalarDataList[idx];
}

const VectorGrid2Ptr& GridSystemData2::GetAdvectableVectorDataAt(
    size_t idx) const
{
...
void GridSystemData2::Serialize(std::vector<uint8_t>* buffer) const
{
    ...
    fbs::Vector2UZ resolution = CubbyFlowToFlatbuffers(m_resolution);
    ...
    SerializeGrid(&builder, m_scalarDataList, fbs::CreateScalarGridSerialized2,
                  &scalarDataList);
    SerializeGrid(&builder, m_vectorDataList, fbs::CreateVectorGridSerialized2,
                  &vectorDataList);
