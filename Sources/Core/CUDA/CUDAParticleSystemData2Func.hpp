...
#ifndef CUBBYFLOW_CUDA_PARTICLE_SYSTEM_DATA2_FUNC_HPP
#define CUBBYFLOW_CUDA_PARTICLE_SYSTEM_DATA2_FUNC_HPP
...
class ForEachNeighborFunc
{
 public:
    ...
    {
        const float2 origin = m_origins[i];
 ...
 private:
    ...
    CUDAPointHashGridSearcher2::HashUtils m_hashUtils;
    float m_radius;
