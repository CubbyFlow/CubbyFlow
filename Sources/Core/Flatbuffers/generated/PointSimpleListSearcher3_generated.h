...
inline flatbuffers::Offset<PointSimpleListSearcher3> CreatePointSimpleListSearcher3Direct(
  ...
  return CubbyFlow::fbs::CreatePointSimpleListSearcher3(
      _fbb,
      points ? _fbb.CreateVector<const CubbyFlow::fbs::Vector3D *>(*points) : 0);
}

inline const CubbyFlow::fbs::PointSimpleListSearcher3 *GetPointSimpleListSearcher3(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::PointSimpleListSearcher3>(buf);
}

inline bool VerifyPointSimpleListSearcher3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::PointSimpleListSearcher3>(nullptr);
}

inline void FinishPointSimpleListSearcher3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::PointSimpleListSearcher3> root) {
  fbb.Finish(root);
}
