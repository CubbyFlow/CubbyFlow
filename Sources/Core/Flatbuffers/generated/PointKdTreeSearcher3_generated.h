...
#ifndef FLATBUFFERS_GENERATED_POINTKDTREESEARCHER3_CUBBYFLOW_FBS_H_
#define FLATBUFFERS_GENERATED_POINTKDTREESEARCHER3_CUBBYFLOW_FBS_H_
...
inline flatbuffers::Offset<PointKdTreeSearcher3> CreatePointKdTreeSearcher3Direct(
  ...
  return CubbyFlow::fbs::CreatePointKdTreeSearcher3(
      _fbb,
...
inline const CubbyFlow::fbs::PointKdTreeSearcher3 *GetPointKdTreeSearcher3(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::PointKdTreeSearcher3>(buf);
}

inline bool VerifyPointKdTreeSearcher3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::PointKdTreeSearcher3>(nullptr);
}

inline void FinishPointKdTreeSearcher3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::PointKdTreeSearcher3> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_POINTKDTREESEARCHER3_CUBBYFLOW_FBS_H_
