...
#ifndef FLATBUFFERS_GENERATED_POINTKDTREESEARCHER2_CUBBYFLOW_FBS_H_
#define FLATBUFFERS_GENERATED_POINTKDTREESEARCHER2_CUBBYFLOW_FBS_H_
...
inline flatbuffers::Offset<PointKdTreeSearcher2> CreatePointKdTreeSearcher2Direct(
  ...
  return CubbyFlow::fbs::CreatePointKdTreeSearcher2(
      _fbb,
...
inline const CubbyFlow::fbs::PointKdTreeSearcher2 *GetPointKdTreeSearcher2(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::PointKdTreeSearcher2>(buf);
}

inline bool VerifyPointKdTreeSearcher2Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::PointKdTreeSearcher2>(nullptr);
}

inline void FinishPointKdTreeSearcher2Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::PointKdTreeSearcher2> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_POINTKDTREESEARCHER2_CUBBYFLOW_FBS_H_
