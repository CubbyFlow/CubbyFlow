...
struct SPHSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const CubbyFlow::fbs::ParticleSystemData3 *base() const {
    return GetPointer<const CubbyFlow::fbs::ParticleSystemData3 *>(VT_BASE);
  }
...
struct SPHSystemData3Builder {
  ...
  void add_base(flatbuffers::Offset<CubbyFlow::fbs::ParticleSystemData3> base) {
...
inline const CubbyFlow::fbs::SPHSystemData3 *GetSPHSystemData3(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::SPHSystemData3>(buf);
}

inline bool VerifySPHSystemData3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::SPHSystemData3>(nullptr);
}

inline void FinishSPHSystemData3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::SPHSystemData3> root) {
  fbb.Finish(root);
}
