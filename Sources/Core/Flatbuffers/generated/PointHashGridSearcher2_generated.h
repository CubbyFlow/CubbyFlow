...
inline flatbuffers::Offset<PointHashGridSearcherBucket2> CreatePointHashGridSearcherBucket2Direct(
  ...
  return CubbyFlow::fbs::CreatePointHashGridSearcherBucket2(
      _fbb,
...
inline flatbuffers::Offset<PointHashGridSearcher2> CreatePointHashGridSearcher2Direct(
  ...
  return CubbyFlow::fbs::CreatePointHashGridSearcher2(
      _fbb,
      gridSpacing,
      resolution,
...
inline const CubbyFlow::fbs::PointHashGridSearcher2 *GetPointHashGridSearcher2(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::PointHashGridSearcher2>(buf);
}

inline bool VerifyPointHashGridSearcher2Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::PointHashGridSearcher2>(nullptr);
}

inline void FinishPointHashGridSearcher2Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::PointHashGridSearcher2> root) {
  fbb.Finish(root);
}
