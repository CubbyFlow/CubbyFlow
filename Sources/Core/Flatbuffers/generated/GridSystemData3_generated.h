...
#ifndef FLATBUFFERS_GENERATED_GRIDSYSTEMDATA3_CUBBYFLOW_FBS_H_
#define FLATBUFFERS_GENERATED_GRIDSYSTEMDATA3_CUBBYFLOW_FBS_H_
...
inline flatbuffers::Offset<ScalarGridSerialized3> CreateScalarGridSerialized3Direct(
  ...
  return CubbyFlow::fbs::CreateScalarGridSerialized3(
      _fbb,
...
inline flatbuffers::Offset<VectorGridSerialized3> CreateVectorGridSerialized3Direct(
    ...
    const char *type = nullptr,
    const std::vector<uint8_t> *data = nullptr) {
  return CubbyFlow::fbs::CreateVectorGridSerialized3(
      _fbb,
      type ? _fbb.CreateString(type) : 0,
      data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3Direct(
  ...
  return CubbyFlow::fbs::CreateGridSystemData3(
      _fbb,
      resolution,
      gridSpacing,
      origin,
...
inline const CubbyFlow::fbs::GridSystemData3 *GetGridSystemData3(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::GridSystemData3>(buf);
}

inline bool VerifyGridSystemData3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::GridSystemData3>(nullptr);
}

inline void FinishGridSystemData3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::GridSystemData3> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_GRIDSYSTEMDATA3_CUBBYFLOW_FBS_H_
