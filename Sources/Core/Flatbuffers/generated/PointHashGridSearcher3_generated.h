...
inline flatbuffers::Offset<PointHashGridSearcherBucket3> CreatePointHashGridSearcherBucket3Direct(
  ...
  return CubbyFlow::fbs::CreatePointHashGridSearcherBucket3(
      _fbb,
...
struct PointHashGridSearcher3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *> *points() const {
    return GetPointer<const flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *> *>(VT_POINTS);
  }
...
struct PointHashGridSearcher3Builder {
  ...
  void add_points(flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *>> points) {
...
inline flatbuffers::Offset<PointHashGridSearcher3> CreatePointHashGridSearcher3Direct(
  ...
  return CubbyFlow::fbs::CreatePointHashGridSearcher3(
      _fbb,
      gridSpacing,
      resolution,
      points ? _fbb.CreateVector<const CubbyFlow::fbs::Vector3D *>(*points) : 0,
      buckets ? _fbb.CreateVector<flatbuffers::Offset<PointHashGridSearcherBucket3>>(*buckets) : 0);
}

inline const CubbyFlow::fbs::PointHashGridSearcher3 *GetPointHashGridSearcher3(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::PointHashGridSearcher3>(buf);
}

inline bool VerifyPointHashGridSearcher3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::PointHashGridSearcher3>(nullptr);
}

inline void FinishPointHashGridSearcher3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::PointHashGridSearcher3> root) {
  fbb.Finish(root);
}
