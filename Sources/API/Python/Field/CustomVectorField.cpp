/*************************************************************************
> File Name: CustomVectorField.cpp
...
{
	pybind11::class_<CustomVectorField2, CustomVectorField2Ptr, VectorField2>(static_cast<pybind11::handle>(m), "CustomVectorField2",
		R"pbdoc(
			2-D vector field with custom field function.
		)pbdoc")
	.def("__init__", [](CustomVectorField2& instance, pybind11::function func, pybind11::function divFunc, pybind11::function curlFunc)
	{
		if (!divFunc)
		{
			new (&instance) CustomVectorField2([func](const Vector2D& x) -> Vector2D
			{
		...
		pybind11::arg("func"),
		pybind11::arg("divFunc") = nullptr,
		pybind11::arg("curlFunc") = nullptr)
	.def("Sample", [](const CustomVectorField2& instance, pybind11::object obj)
	{
		...
		pybind11::arg("x"))
	.def("Divergence", [](const CustomVectorField2& instance, pybind11::object obj)
	{
		...
		pybind11::arg("x"))
	.def("Curl", [](const CustomVectorField2& instance, pybind11::object obj)
	{
		return instance.Curl(ObjectToVector2D(obj));
	},
		R"pbdoc(Returns curl at given position `x`.)pbdoc", pybind11::arg("x"))
	.def("Sampler", [](const CustomVectorField2& instance)
	{
...
{
	pybind11::class_<CustomVectorField3, CustomVectorField3Ptr, VectorField3>(static_cast<pybind11::handle>(m), "CustomVectorField3",
		R"pbdoc(
			3-D vector field with custom field function.
		)pbdoc")
	.def("__init__", [](CustomVectorField3& instance, pybind11::function func, pybind11::function divFunc, pybind11::function curlFunc)
	{
		if (!divFunc)
		{
			new (&instance) CustomVectorField3([func](const Vector3D& x) -> Vector3D
			{
		...
		pybind11::arg("divFunc") = nullptr,
		pybind11::arg("curlFunc") = nullptr)
	.def("Sample", [](const CustomVectorField3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("x"))
	.def("Divergence", [](const CustomVectorField3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("x"))
	.def("Curl", [](const CustomVectorField3& instance, pybind11::object obj)
	{
		...
		pybind11::arg("x"))
	.def("Sampler", [](const CustomVectorField3& instance)
	{
		return instance.Sampler();
	},
		R"pbdoc(
