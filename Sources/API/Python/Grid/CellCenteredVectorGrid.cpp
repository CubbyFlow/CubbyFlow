...
{
    pybind11::class_<CellCenteredVectorGrid2, CellCenteredVectorGrid2Ptr,
                     CollocatedVectorGrid2>(static_cast<pybind11::handle>(m),
        ...
        .def(
            "__init__",
            [](CellCenteredVectorGrid2& instance, pybind11::args args,
               pybind11::kwargs kwargs) {
                ...
                ParseGridResizeParams(args, kwargs, resolution, gridSpacing,
                                      gridOrigin);
                new (&instance) CellCenteredVectorGrid2(resolution, gridSpacing,
                                                        gridOrigin);
            },
            R"pbdoc(
			Constructs grid.
        ...
        .def(
            "Fill",
            [](CellCenteredVectorGrid2& instance, pybind11::object obj) {
                if (pybind11::isinstance<Vector2D>(
                        static_cast<pybind11::handle>(obj)))
                {
                    instance.Fill(obj.cast<Vector2D>());
                }
                else if (pybind11::isinstance<pybind11::tuple>(
                             static_cast<pybind11::handle>(obj)))
                {
...
{
    pybind11::class_<CellCenteredVectorGrid3, CellCenteredVectorGrid3Ptr,
                     CollocatedVectorGrid3>(static_cast<pybind11::handle>(m),
        ...
        .def(
            "__init__",
            [](CellCenteredVectorGrid3& instance, pybind11::args args,
               pybind11::kwargs kwargs) {
                ...
                ParseGridResizeParams(args, kwargs, resolution, gridSpacing,
                                      gridOrigin);
                new (&instance) CellCenteredVectorGrid3(resolution, gridSpacing,
                                                        gridOrigin);
            },
            R"pbdoc(
			Constructs grid.
        ...
        .def(
            "Fill",
            [](CellCenteredVectorGrid3& instance, pybind11::object obj) {
                if (pybind11::isinstance<Vector3D>(
                        static_cast<pybind11::handle>(obj)))
                {
