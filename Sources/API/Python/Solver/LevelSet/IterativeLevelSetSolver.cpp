...
{
    pybind11::class_<IterativeLevelSetSolver2, IterativeLevelSetSolver2Ptr,
                     LevelSetSolver2>(static_cast<pybind11::handle>(m),
        ...
        .def_property("maxCFL", &IterativeLevelSetSolver2::GetMaxCFL,
...
{
    pybind11::class_<IterativeLevelSetSolver3, IterativeLevelSetSolver3Ptr,
                     LevelSetSolver3>(static_cast<pybind11::handle>(m),
        ...
        .def(
            ...
            pybind11::arg("input"), pybind11::arg("sdf"),
            pybind11::arg("maxDistance"), pybind11::arg("output"))
        .def_property("maxCFL", &IterativeLevelSetSolver3::GetMaxCFL,
