...
{
    pybind11::class_<LevelSetLiquidSolver2, LevelSetLiquidSolver2Ptr,
        ...
        .def(
            "__init__",
            [](LevelSetLiquidSolver2& instance, pybind11::args args,
               pybind11::kwargs kwargs) {
                Vector2UZ resolution{ 1, 1, 1 };
        ...
        .def_property_readonly("signedDistanceField",
                               &LevelSetLiquidSolver2::GetSignedDistanceField,
                               R"pbdoc(
			The signed-distance field.
		)pbdoc")
        .def_property("levelSetSolver",
                      &LevelSetLiquidSolver2::GetLevelSetSolver,
...
{
    pybind11::class_<LevelSetLiquidSolver3, LevelSetLiquidSolver3Ptr,
        ...
        .def(
            "__init__",
            [](LevelSetLiquidSolver3& instance, pybind11::args args,
               pybind11::kwargs kwargs) {
        ...
        .def_property_readonly("signedDistanceField",
                               &LevelSetLiquidSolver3::GetSignedDistanceField,
                               R"pbdoc(
			The signed-distance field.
		)pbdoc")
        .def_property("levelSetSolver",
                      &LevelSetLiquidSolver3::GetLevelSetSolver,
