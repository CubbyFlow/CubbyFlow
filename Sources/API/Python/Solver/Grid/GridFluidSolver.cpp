...
{
    pybind11::class_<GridFluidSolver2, GridFluidSolver2Ptr, PhysicsAnimation>(
        m, "GridFluidSolver2",
        R"pbdoc(
        ...
        .def_property(
            "gravity", &GridFluidSolver2::GetGravity,
            [](GridFluidSolver2& instance, pybind11::object obj) {
        ...
        .def_property("viscosityCoefficient",
                      &GridFluidSolver2::GetViscosityCoefficient,
...
{
    pybind11::class_<GridFluidSolver3, GridFluidSolver3Ptr, PhysicsAnimation>(
        m, "GridFluidSolver3",
        R"pbdoc(
        ...
        .def_property(
            "gravity", &GridFluidSolver3::GetGravity,
            [](GridFluidSolver3& instance, pybind11::object obj) {
        ...
        .def_property("viscosityCoefficient",
                      &GridFluidSolver3::GetViscosityCoefficient,
        ...
        .def("GetCFL", &GridFluidSolver3::GetCFL,
			...
			- timeIntervalInSeconds : The time interval in seconds.
             ...
             pybind11::arg("timeIntervalInSeconds"))
        .def_property("maxCFL", &GridFluidSolver3::GetMaxCFL,
                      &GridFluidSolver3::SetMaxCFL,
                      R"pbdoc(
			The max allowed CFL number.
		)pbdoc")
        .def_property("useCompressedLinearSystem",
                      &GridFluidSolver3::GetUseCompressedLinearSystem,
                      &GridFluidSolver3::SetUseCompressedLinearSystem,
                      R"pbdoc(
			True if the solver is using compressed linear system.
		)pbdoc")
        .def_property("advectionSolver", &GridFluidSolver3::GetAdvectionSolver,
                      &GridFluidSolver3::SetAdvectionSolver,
                      R"pbdoc(
			The advection solver.
		)pbdoc")
        .def_property("diffusionSolver", &GridFluidSolver3::GetDiffusionSolver,
                      &GridFluidSolver3::SetDiffusionSolver,
                      R"pbdoc(
			The diffusion solver instance.
		)pbdoc")
        .def_property("pressureSolver", &GridFluidSolver3::GetPressureSolver,
                      &GridFluidSolver3::SetPressureSolver,
                      R"pbdoc(
			The pressure solver instance.
		)pbdoc")
        .def_property("closedDomainBoundaryFlag",
                      &GridFluidSolver3::GetClosedDomainBoundaryFlag,
