    ...
    pybind11::class_<ParticleSystemSolver2, ParticleSystemSolver2Ptr,
        ...
        .def(pybind11::init<double, double>(),
			...
			- mass : Mass of a particle in kg (default 1e-2).
             ...
             pybind11::arg("radius") = 1e-2, pybind11::arg("mass") = 1e-2)
        .def_property("dragCoefficient",
                      &ParticleSystemSolver2::GetDragCoefficient,
        ...
        .def_property("restitutionCoefficient",
                      &ParticleSystemSolver2::GetRestitutionCoefficient,
        ...
        .def_property("gravity", &ParticleSystemSolver2::GetGravity,
                      &ParticleSystemSolver2::SetGravity,
                      R"pbdoc(
			The gravity.
		)pbdoc")
        .def_property_readonly("particleSystemData",
                               &ParticleSystemSolver2::GetParticleSystemData,
                               R"pbdoc(
        ...
        .def_property("collider", &ParticleSystemSolver2::GetCollider,
                      &ParticleSystemSolver2::SetCollider,
                      R"pbdoc(
			The collider.
		)pbdoc")
        .def_property("emitter", &ParticleSystemSolver2::GetEmitter,
                      &ParticleSystemSolver2::SetEmitter,
                      R"pbdoc(
			The emitter.
		)pbdoc")
        .def_property("wind", &ParticleSystemSolver2::GetWind,
...
void AddParticleSystemSolver3(pybind11::module& m)
{
    pybind11::class_<ParticleSystemSolver3, ParticleSystemSolver3Ptr,
        ...
        .def_property("dragCoefficient",
                      &ParticleSystemSolver3::GetDragCoefficient,
        ...
        .def_property("restitutionCoefficient",
                      &ParticleSystemSolver3::GetRestitutionCoefficient,
        ...
        .def_property("gravity", &ParticleSystemSolver3::GetGravity,
                      &ParticleSystemSolver3::SetGravity,
                      R"pbdoc(
			The gravity.
		)pbdoc")
        .def_property_readonly("particleSystemData",
                               &ParticleSystemSolver3::GetParticleSystemData,
                               R"pbdoc(
			The the particle system data.
        ...
        .def_property("collider", &ParticleSystemSolver3::GetCollider,
                      &ParticleSystemSolver3::SetCollider,
                      R"pbdoc(
			The collider.
		)pbdoc")
        .def_property("emitter", &ParticleSystemSolver3::GetEmitter,
                      &ParticleSystemSolver3::SetEmitter,
                      R"pbdoc(
			The emitter.
		)pbdoc")
        .def_property("wind", &ParticleSystemSolver3::GetWind,
