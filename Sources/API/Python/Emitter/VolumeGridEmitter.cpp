...
{
    pybind11::class_<VolumeGridEmitter2, VolumeGridEmitter2Ptr, GridEmitter2>(
        ...
        .def(
            ...
            pybind11::arg("sourceRegion"), pybind11::arg("isOneShot") = true)
        ...
        .def("AddStepFunctionTarget",
			...
			- maxValue : The maximum value of the step function.
             ...
             pybind11::arg("scalarGridTarget"), pybind11::arg("minValue"),
             pybind11::arg("maxValue"))
        .def(
            "AddTarget",
            [](VolumeGridEmitter2& instance, pybind11::object obj,
               pybind11::function mapper) {
            ...
            pybind11::arg("scalarGridTarget"), pybind11::arg("customMapper"))
        .def_property_readonly("sourceRegion",
                               &VolumeGridEmitter2::GetSourceRegion,
                               R"pbdoc(
...
{
    pybind11::class_<VolumeGridEmitter3, VolumeGridEmitter3Ptr, GridEmitter3>(
        ...
        .def(
            "AddTarget",
            [](VolumeGridEmitter3& instance, pybind11::object obj,
               pybind11::function mapper) {
            ...
            pybind11::arg("scalarGridTarget"), pybind11::arg("customMapper"))
        .def_property_readonly("sourceRegion",
                               &VolumeGridEmitter3::GetSourceRegion,
                               R"pbdoc(
			Implicit surface which defines the source region.
		)pbdoc")
